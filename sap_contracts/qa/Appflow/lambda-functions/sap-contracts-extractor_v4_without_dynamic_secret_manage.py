...
AUDIT_TABLE     = "edp_configs_dev.pipeline_execution_summary"
ATHENA_DB       = "edp_configs_dev"
ATHENA_OUTPUT   = "s3://aws-athena-query-results-us-east-1-730878889077/"
...
def update_audit_failure(
    ...
    """
    Update the RUNNING row to FAILED on any unhandled exception.
    Records read/written are included if the failure happened mid-run
    (i.e. after partial data was already fetched).
    ...
    Example SQL generated:
        ...
        SET
          status            = 'FAILED',
          error_message     = 'HTTPError: 503 SAP API unavailable',
          records_read      = 120,
          records_written   = 0,
          pipeline_end_time = TIMESTAMP '2024-01-15 09:32:15.000',
